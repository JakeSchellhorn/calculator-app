...
input_frame = tk.Frame(frame, width = 302, height = 50, bg = "silver")
input_frame.pack()
...
#row 1
clear = tk.Button(button_frame, text = "C", width = 19, height = 2, 
...
#row 2
seven = tk.Button(button_frame, text = "7", width = 5, height = 2, 
                  command = lambda: btn_click(7)).grid(row = 1, column = 0, padx = 1, pady = 1)
eight = tk.Button(button_frame, text = "8", width = 5, height = 2, 
                  command = lambda: btn_click(8)).grid(row = 1, column = 1, padx = 1, pady = 1)
nine = tk.Button(button_frame, text = "9", width = 5, height = 2, 
...
#row 3
four = tk.Button(button_frame, text = "4", width = 5, height = 2, 
                  command = lambda: btn_click(4)).grid(row = 2, column = 0, padx = 1, pady = 1)
five = tk.Button(button_frame, text = "5", width = 5, height = 2, 
                  command = lambda: btn_click(5)).grid(row = 2, column = 1, padx = 1, pady = 1)
six = tk.Button(button_frame, text = "6", width = 5, height = 2, 
                 command = lambda: btn_click(6)).grid(row = 2, column = 2, padx = 1, pady = 1)
subtract = tk.Button(button_frame, text = "-", width = 5, height = 2, 
                     command = lambda: btn_click("-")).grid(row = 2, column = 4, padx = 1, pady = 1)

#row 4
one = tk.Button(button_frame, text = "1", width = 5, height = 2, 
                  command = lambda: btn_click(1)).grid(row = 3, column = 0, padx = 1, pady = 1)
two = tk.Button(button_frame, text = "2", width = 5, height = 2, 
                  command = lambda: btn_click(2)).grid(row = 3, column = 1, padx = 1, pady = 1)
three = tk.Button(button_frame, text = "3", width = 5, height = 2, 
                 command = lambda: btn_click(3)).grid(row = 3, column = 2, padx = 1, pady = 1)
add = tk.Button(button_frame, text = "+", width = 5, height = 2, 
                     command = lambda: btn_click("+")).grid(row = 3, column = 4, padx = 1, pady = 1)

#row 5
zero = tk.Button(button_frame, text = "0", width = 19, height = 2, 
